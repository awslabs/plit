...
#####################################################################################
# Additional PYTHONPATH to allow notebooks to import custom modules at a few
# pre-defined places.
...
try:
    ...
    print("onehuonetuaoeu")

c.InteractiveShellApp.exec_lines = _pythonpath  # type: ignore # noqa: F821
#####################################################################################

# Ref:
# https://github.com/verdimrc/python-project-skeleton/blob/master/ipython_config.py
